    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          return Scaffold(
            appBar: AppBar(title: const Text('Minhas Vacinas', style: AppTheme.titleSmallStyle), centerTitle: true),
            body: Stack(
              children: [
                // Corpo principal
                Padding(
                  ...
                  child: Observer(
                    builder: (context) {
                      if (controller.vaccines.isEmpty) {
                        return const Center(child: Text('Carregando as vacinas', style: AppTheme.subTitleStyle));
                      }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Align(
                                ...
                                child: Text('Qualquer tempo', style: AppTheme.titleSmallStyle),
                              ),
