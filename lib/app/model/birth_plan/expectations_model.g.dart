...
ExpectationsModel _$ExpectationsModelFromJson(Map<String, dynamic> json) =>
    ExpectationsModel(
      ...
      shaveIntimateHair: $enumDecode(
        _$AlternativesEnumMap,
        json['shaveIntimateHair'],
      ),
      bowelWashOrSuppository: $enumDecode(
        _$AlternativesEnumMap,
        json['bowelWashOrSuppository'],
      ),
      lowLightEnvironment: $enumDecode(
        _$AlternativesEnumMap,
        json['lowLightEnvironment'],
      ),
      ...
      recordPhotosOrVideos: $enumDecode(
        _$AlternativesEnumMap,
        json['recordPhotosOrVideos'],
      ),
    );

Map<String, dynamic> _$ExpectationsModelToJson(
  ExpectationsModel instance,
) => <String, dynamic>{
  ...
  'lowLightEnvironment': _$AlternativesEnumMap[instance.lowLightEnvironment]!,
  'listenToMusic': _$AlternativesEnumMap[instance.listenToMusic]!,
  'drinkLiquids': _$AlternativesEnumMap[instance.drinkLiquids]!,
  'recordPhotosOrVideos': _$AlternativesEnumMap[instance.recordPhotosOrVideos]!,
};
