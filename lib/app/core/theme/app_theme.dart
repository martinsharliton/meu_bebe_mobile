...
final class AppTheme {
  static const primaryColor = Color(0xFFD6F0FF); // Azul bebê bem suave, quase pastel
  static const secondaryColor = Color(0xFFBEE8FF); // Azul clarinho para fundos e destaques sutis
  static const darkTextColor = Color(0xFF3B7C9E); // Azul mais escuro para texto, bom contraste
  static const textColor = Color(0xFF6FB8D8); // Azul médio delicado para textos e ícones
  ...
  static const _buttonTextStyle = TextStyle(fontSize: 14, fontFamily: 'SFProDisplay', fontWeight: FontWeight.w700);
}
